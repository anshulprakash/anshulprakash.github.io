...
jQuery(document).ready(function () {
    ...
    jQuery('#personal-typed').typed({
        strings: [' a Developer &  an Aspiring Data Scientist', 'a Graduate Student at Texas A&M University', 'a Polyglot Programmer', 'in love with Technology'],
        loop: true,
        typeSpeed: 30,
        backDelay: 2000,
        loopCount: false
        ...
        if (!jQuery('body').hasClass('single-project')) {
            setTimeout(function () {
                notification = new NotificationFx({
                    ...
                    layout: 'growl',
                    effect: 'slide',
                    message: '<p>Please say hello to my chatbot in the bottom right corner.</p>'
                });
                notification.show();
            }, 1000);
        }
